...
const AerialPage = () => {
  ...
  let tagline = (process.env.TAGLINE_DESC) ? process.env.TAGLINE_DESC : "Project On-Hold | Domain Unavailable"
  let devURL = (process.env.DEV_URL) ? process.env.DEV_URL : "https://github.com/dsthedev?tab=repositories"
